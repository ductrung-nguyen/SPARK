...
object TestingWorkSheet {
    ...
    val context = new SparkContext("local", "SparkContext")
                                                  //> 14/01/17 04:51:02 WARN util.Utils: Your hostname, ubuntu resolves to a loop
                                                  //| back address: 127.0.1.1; using 192.168.190.142 instead (on interface eth0)
                                                  //| 14/01/17 04:51:02 WARN util.Utils: Set SPARK_LOCAL_IP if you need to bind t
                                                  //| o another address
                                                  //| 14/01/17 04:51:02 INFO slf4j.Slf4jEventHandler: Slf4jEventHandler started
                                                  //| 14/01/17 04:51:02 INFO spark.SparkEnv: Registering BlockManagerMaster
                                                  //| 14/01/17 04:51:02 INFO storage.MemoryStore: MemoryStore started with capaci
                                                  //| ty 390.7 MB.
                                                  //| 14/01/17 04:51:02 INFO storage.DiskStore: Created local directory at /tmp/s
                                                  //| park-local-20140117045102-8468
                                                  //| 14/01/17 04:51:02 INFO network.ConnectionManager: Bound socket to port 4357
                                                  //| 9 with id = ConnectionManagerId(ubuntu.local,43579)
                                                  //| 14/01/17 04:51:03 INFO storage.BlockManagerMaster: Trying to register Block
                                                  //| Manager
                                                  //| 14/01/17 04:51:03 INFO storage.BlockManagerMasterActor$BlockManagerInfo: Re
                                                  //| gistering block manager ubuntu.local:43579 with
    ...
    var featureSet = new FeatureSet("/home/loveallufev/semester_project/input/tag_small_input2", context)
		...
		val myDataFile = context.textFile(dataInputURL, 1)
                                                  //> 14/01/17 04:51:04 INFO storage.MemoryStore: ensureFreeSpace(33736) called w
                                                  //| ith curMem=0, maxMem=409699614
                                                  //| 14/01/17 04:51:04 INFO storage.MemoryStore: Block broadcast_0 stored as val
                                                  //| ues to memory (estimated size 32.9 KB, free 390.7 MB)
                                                  //| myDataFile  : org.apache.spark.rdd.RDD[String] = MappedRDD[1] at textFile a
                                                  //| t machinelearning.TestingWorkSheet.scala:73
    ...
    var mydata = myDataFile.map(line => line.split(","))
                                                  ...
                                                  //| at map at machinelearning.TestingWorkSheet.scala:76
    val number_of_features = mydata.take(1)(0).length
                                                  //> 14/01/17 04:51:04 WARN util.NativeCodeLoader: Unable to load native-hadoop 
                                                  //| library for your platform... using builtin-java classes where applicable
                                                  //| 14/01/17 04:51:04 WARN snappy.LoadSnappy: Snappy native library not loaded
                                                  //| 14/01/17 04:51:04 INFO mapred.FileInputFormat: Total input paths to process
                                                  //|  : 1
                                                  //| 14/01/17 04:51:04 INFO spark.SparkContext: Starting job: take at machinelea
                                                  //| rning.TestingWorkSheet.scala:77
                                                  //| 14/01/17 04:51:04 INFO scheduler.DAGScheduler: Got job 0 (take at machinele
                                                  //| arning.TestingWorkSheet.scala:77) with 1 output partitions (allowLocal=true
                                                  //| )
                                                  //| 14/01/17 04:51:04 INFO scheduler.DAGScheduler: Final stage: Stage 0 (take a
                                                  //| t machinelearning.TestingWorkSheet.scala:77)
                                                  //| 14/01/17 04:51:04 INFO scheduler.DAGScheduler: Parents of final stage: List
                                                  //| ()
                                                  //| 14/01/17 04:51:04 INFO scheduler.DAGScheduler: Missing parents: List()
                                                  //| 14/01/17 04:51:04 INFO scheduler.DAGScheduler: Computing the requested part
                                                  //| i
                                                  //| Output exceeds cutoff limit.
    val featureTypes = Vector[String]() ++ featureSet.data.map(x => x.Type)
                                                  //> 14/01/17 04:51:04 INFO storage.MemoryStore: ensureFreeSpace(33744) called w
                                                  //| ith curMem=33736, maxMem=409699614
                                                  //| 14/01/17 04:51:04 INFO storage.MemoryStore: Block broadcast_1 stored as val
                                                  //| ues to memory (estimated size 33.0 KB, free 390.7 MB)
                                                  //| 14/01/17 04:51:04 INFO mapred.FileInputFormat: Total input paths to process
                                                  //|  : 1
                                                  //| 14/01/17 04:51:04 INFO spark.SparkContext: Starting job: take at machinelea
                                                  //| rning.TestingWorkSheet.scala:28
                                                  //| 14/01/17 04:51:04 INFO scheduler.DAGScheduler: Got job 1 (take at machinele
                                                  //| arning.TestingWorkSheet.scala:28) with 1 output partitions (allowLocal=true
                                                  //| )
                                                  //| 14/01/17 04:51:04 INFO scheduler.DAGScheduler: Final stage: Stage 1 (take a
                                                  //| t machinelearning.TestingWorkSheet.scala:28)
                                                  //| 14/01/17 04:51:04 INFO scheduler.DAGScheduler: Parents of final stage: List
                                                  //| ()
                                                  //| 14/01/17 04:51:04 INFO scheduler.DAGScheduler: Missing parents: List()
                                                  //| 14/01/17 04:51:04 INFO scheduler.DAGScheduler: Computing the
                                                  //| Output exceeds cutoff limit.
    val aggregateData = mydata.map(processLine(_, number_of_features, featureTypes))
                                                  ...
                                                  //| chinelearning.TestingWorkSheet.scala:79
    println(buildTree(aggregateData))             //> 14/01/17 04:51:04 INFO spark.SparkContext: Starting job: take at machinelea
                                                  //| rning.TestingWorkSheet.scala:86
                                                  //| 14/01/17 04:51:04 INFO scheduler.DAGScheduler: Registering RDD 7 (groupBy a
                                                  //| t machinelearning.TestingWorkSheet.scala:86)
                                                  //| 14/01/17 04:51:04 INFO scheduler.DAGScheduler: Got job 2 (take at machinele
                                                  //| arning.TestingWorkSheet.scala:86) with 1 output partitions (allowLocal=true
                                                  //| )
                                                  //| 14/01/17 04:51:04 INFO scheduler.DAGScheduler: Final stage: Stage 2 (take a
                                                  //| t machinelearning.TestingWorkSheet.scala:86)
                                                  //| 14/01/17 04:51:04 INFO scheduler.DAGScheduler: Parents of final stage: List
                                                  //| (Stage 3)
                                                  //| 14/01/17 04:51:04 INFO scheduler.DAGScheduler: Missing parents: List(Stage 
                                                  //| 3)
                                                  //| 14/01/17 04:51:04 INFO scheduler.DAGScheduler: Submitting Stage 3 (MappedRD
                                                  //| D[7] at groupBy at machinelearning.TestingWorkSheet.scala:86), which has no
                                                  //|  missing parents
                                                  //| 14/01/17 04:51:04 INFO scheduler.DAGScheduler: Failed to run take at machin
