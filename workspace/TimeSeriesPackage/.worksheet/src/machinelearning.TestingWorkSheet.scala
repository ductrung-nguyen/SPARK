...
object TestingWorkSheet {
    ...
    };import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(1741); 
    ...
    var featureSet = new FeatureSet("/home/loveallufev/semester_project/input/tag_small_input2", context);System.out.println("""featureSet  : machinelearning.TestingWorkSheet.FeatureSet = """ + $show(featureSet ));$skip(53); 
    ...
    val aggregateData = mydata.map(processLine(_, number_of_features, featureTypes));System.out.println("""aggregateData  : org.apache.spark.rdd.RDD[org.apache.spark.rdd.RDD[machinelearning.TestingWorkSheet.FeatureAggregateInfo]] = """ + $show(aggregateData ));$skip(38); 
    ...
    };System.out.println("""buildTree: (data: org.apache.spark.rdd.RDD[org.apache.spark.rdd.RDD[machinelearning.TestingWorkSheet.FeatureAggregateInfo]])machinelearning.Node""")}
